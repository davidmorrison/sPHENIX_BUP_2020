...
the elements of the original DOE MIE --- the outer hadronic calorimeter (oHCal), the
...
Fig.~\ref{fig:mvtx_oblique}.  The MVTX is capable of 5~$\mu m$ resolution for
...
project could proceed remotely.  
Design work and reviews continued.  
...
%but without endangering the schedule leading to the planned date of PD-4.
