...
// ------------>Primitives in pad: D0_BUP2020OO_significance_5yr_1
   ...
   TH1F *Graph_Graph07 = new TH1F("Graph_Graph07","Significance for N_Collision = 4.1519e+10 centrality_ncoll = 9.6000e+00, based on 60-80%, w/o TOF, 48B",100,0,10.7);
   Graph_Graph07->SetMinimum(18.29657);
   Graph_Graph07->SetMaximum(458.0108);
...
// ------------>Primitives in pad: D0_BUP2020OO_significance_5yr_2
   ...
   TH1F *Graph_Graph08 = new TH1F("Graph_Graph08","Significance for N_Collision = 4.1519e+10 centrality_ncoll = 9.6000e+00, based on 60-80%, w/o TOF, 48B",100,0,10.4);
   Graph_Graph08->SetMinimum(4.022269);
   Graph_Graph08->SetMaximum(24.12915);
