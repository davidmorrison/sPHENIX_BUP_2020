...
\documentclass[11pt,openany,notitlepage]{book}

\RequirePackage{lineno}
% added by dvp for FloatBarrier
\usepackage{placeins}
...
\input{commissioning}
\input{readout}
\input{physics_projections}
%\input{species_scan} - jln, this needs to all go into the out years... below.
\input{bupextra}
\input{summary}
