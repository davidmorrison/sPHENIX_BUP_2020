...
%For charged hadrons, due to their
%strongly suppressed $R_\mathrm{AA}$, the comparison is generally
%limited by \auau data. 
%For jets, the comparison is initially limited
...
%sPHENIX will record approximately $65\,000$ ($50\,000$)
...
Figure~\ref{fig:HF-v2} (left) shows the elliptic flow $v_2$ measurements of the
...
With the large acceptance and multi-observable capability, the sPHENIX
...
The first non-zero Collins and IFF asymmetries in \pp collisions have
