...
``RHIC Collider Projections (FY 2017 –- FY 2027)'' utilized for this study is dated 21 August 2020 and utilizes knowledge gained from the Run-15 \pp and \pAu at 200~GeV running and the Run-16 \auau at 200 GeV running.   The document is available at:
...
Table~\ref{tab:ncoll} details the number of relevant events recorded or sampled for measuring high $p_T$ jets.    We highlight that the \auau sample with an order of magnitude more effective \pp collisions sampled will be divided into multiple centrality bins and jet quenching will reduce the statistics are high $p_T$.   Overall this is a good balance of cold and hot system measurements.
